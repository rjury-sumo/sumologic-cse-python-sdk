...
parser.add_argument("--comment", help="Comment to add to closed insights. If none this will be auto generated by script.")
...
if len(insights) > 0:
    ...
    for i in insights:
        ...
        if n <= args.limit:
            ...
            logger.warning(f"Max delete limit reached of:{args.limit}")
            break
else:
